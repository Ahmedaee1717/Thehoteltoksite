...
emailRoutes.post('/receive', async (c) => {
  ...
  try {
    ...
    console.log('📝 Storing incoming email as plaintext (encryption disabled)');
    ...
    `).bind(
      ...
      to,
      subject,
      bodyTextToStore, // Plaintext (encryption disabled)
      bodyHtmlToStore, // Plaintext (encryption disabled)
